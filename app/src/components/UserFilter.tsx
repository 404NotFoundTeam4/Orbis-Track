...
// }) => {
//   const [search, setSearch] = useState("");
//   const [position, setPosition] = useState<Option | null>(defaultOpt[0]);
//   const [department, setDepartment] = useState<Option | null>(defaultOpt[0]);
//   const [subDepartment, setSubDepartment] = useState<Option | null>(
//     defaultOpt[0]
//   );
...
//             <Select
//               value={subDepartment}
//               onChange={(val) => setSubDepartment(val)}
...
//           {/* Add button */}
//           <div className="flex items-center justify-center w-[150px] h-[46px] border bg-[#1890FF] rounded-full text-[#FFFFFF] cursor-pointer hover:bg-blue-500 transition">
//             <Icon icon="ic:baseline-plus" width="22" height="22" />{" "}
//             เพิ่มบัญชีผู้ใช้
//           </div>
//         </div>
