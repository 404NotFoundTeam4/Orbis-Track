...
router.patchDoc("/:id", { tag: "Accounts", auth: true, params: idParamSchema, body: editAccountSchema, contentType: "multipart/form-data" }, upload.single("us_images"), accountsController.update);
