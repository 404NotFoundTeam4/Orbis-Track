...
-- CreateEnum
CREATE TYPE "BRT_STATUS" AS ENUM ('PENDING', 'APPROVED', 'IN_USE', 'OVERDUE', 'COMPLETED', 'REJECTED');
...
CREATE TABLE "issue_devices" (
    ...
    "id_ti_id" INTEGER NOT NULL,
    "id_dec_id" INTEGER NOT NULL,
    "deleted_at" TIMESTAMPTZ(6),
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ(6) NOT NULL,

    CONSTRAINT "issue_devices_pkey" PRIMARY KEY ("id_id")
);
...
-- CreateIndex
CREATE INDEX "issue_devices_id_ti_id_idx" ON "issue_devices"("id_ti_id");

-- CreateIndex
CREATE INDEX "issue_devices_id_dec_id_idx" ON "issue_devices"("id_dec_id");
...
-- AddForeignKey
ALTER TABLE "issue_devices" ADD CONSTRAINT "issue_devices_id_ti_id_fkey" FOREIGN KEY ("id_ti_id") REFERENCES "ticket_issues"("ti_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "issue_devices" ADD CONSTRAINT "issue_devices_id_dec_id_fkey" FOREIGN KEY ("id_dec_id") REFERENCES "device_childs"("dec_id") ON DELETE RESTRICT ON UPDATE CASCADE;
