...
interface RequestItemProps {
  ...
  onReturn?: (ticketId: number, devices: DeviceReturnStatus[]) => void;
}
          ...
          {(ticket.status === "PENDING" && (
            ...
            (ticket.status === "APPROVED" && (
              <>
                ...
                <div className="w-[105px] h-[44px]"></div>
              </>
            ))}
        </div>
                ...
                <div className="flex flex-col gap-2 flex-1">
                  ...
                  <div className="grid grid-cols-[150px_1fr] items-start">
                    ...
                    {checkLastStage(
                      ...
                      <textarea
                        className={`w-[80%] h-[100px] p-3 bg-white border rounded-xl resize-none text-sm transition-all ${
                          isInvalid
