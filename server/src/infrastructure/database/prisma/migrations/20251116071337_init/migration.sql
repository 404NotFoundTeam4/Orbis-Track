...
-- DropForeignKey
ALTER TABLE "approval_flow_steps" DROP CONSTRAINT "approval_flow_steps_afs_pa_id_fkey";

-- DropForeignKey
ALTER TABLE "borrow_return_ticket_stages" DROP CONSTRAINT "borrow_return_ticket_stages_brts_pa_id_fkey";

-- DropForeignKey
ALTER TABLE "devices" DROP CONSTRAINT "devices_de_sec_id_fkey";

-- DropForeignKey
ALTER TABLE "sections" DROP CONSTRAINT "sections_sec_dept_id_fkey";

-- DropForeignKey
ALTER TABLE "users" DROP CONSTRAINT "users_us_pa_id_fkey";

-- DropIndex
DROP INDEX "idx_steps_flow_step";

-- DropIndex
DROP INDEX "idx_users_position";
